...
class xupdater(QWidget):
    def __init__(self,apt_list,flat_list,xlive_list):
        super().__init__()
    ...
    def closeEvent(self, event):
        # Verhindere das Schließen des Fensters, indem es nur versteckt wird
        os.system("x-live-update-tray &")
        event.accept()
